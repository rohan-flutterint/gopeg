...
//}
//
//func bindNode(n definition.ParsingNode, fields map[string]reflect.Value) error {
//	symbol := n.Symbol()
...
//}
//
//func bind(n definition.ParsingNode, p reflect.Value) error {
...
//}
//
//func Bind(n definition.ParsingNode, v any) error { return bind(n, reflect.ValueOf(v)) }
